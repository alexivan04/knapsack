...
if __name__ == "__main__":
    ...
    num_tests = 30        # Number of test cases to generate
    max_items = 32       # Maximum number of items per test case
    max_capacity = 200     # Maximum capacity of the knapsack
    max_weight = 40       # Maximum weight of an item
    max_value = 50       # Maximum value of an item
